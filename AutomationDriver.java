...
public class AutomationDriver {
	...
	public static void exerciseTwo(WebDriver driver) throws InterruptedException {
		...
		driver.findElement(By.id("autocomplete")).sendKeys("United States Minor Outlying Islands");
		Thread.sleep(2000);
	...
	public static void exericseEight(WebDriver driver) {
	...
	public static void exerciseNine(WebDriver driver) {
		...
		Actions act = new Actions(driver);
		 act.sendKeys(Keys.PAGE_DOWN).build().perform();
		  WebElement we = driver.findElement(By.id("mousehover"));
		  driver.findElement(By.id("mousehover")).click();
		  String strn = we.getText();
	     System.out.println("Text obtained by scrolling down is :"+strn);
	      act.moveToElement(we).build().perform();
	      act.click().build().perform();
	      WebElement we1 = driver.findElement(By.cssSelector("a[href='#top']"));
